...
import com.iflytek.FaceAlignResult;
...
public class ParseResult {
	...
	static public FaceAlignResult parseGsonResult(String json){
		Gson gson = new Gson();
		FaceAlignResult faceAlignResult = gson.fromJson(json, FaceAlignResult.class);
